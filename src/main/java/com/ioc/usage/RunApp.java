...
//		EmployeeService employeeService = (EmployeeService)builder.getBean("employeeServiceImpl");
...
//		UserService userService = (UserService)builder.getBean("userServiceImpl");
//		userService.createUser("Test User");
//		SingletonServiceB b = (SingletonServiceB)builder.getBean("SingletonServiceBImpl");
//		b.provideInfo();
